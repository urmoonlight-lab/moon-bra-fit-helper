...
text estimatedBust = standingBust * 0.45 + leaningBust * 0.35 + lyingBust * 0.20 
...
text index.html styles.css app.js manifest.webmanifest service-worker.js README.md .gitignore 

Do not upload local-only or generated files such as:

text .env node_modules/ logs/ .DS_Store ._* 
